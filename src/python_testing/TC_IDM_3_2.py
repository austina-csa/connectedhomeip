...
class TC_IDM_3_2(MatterBaseTest, BasicCompositionTests):
    ...
    async def test_TC_IDM_3_2(self):
            ...
            for attribute_id in attributes:
                ...
                if write_access:
                    if cluster_id in Clusters.ClusterObjects.ALL_ATTRIBUTES:
                        ...
                        except KeyError as e: # Some XML clusters aren't present in ALL_CLUSTERS or ALL_ATTRIBUTES
                            pass
        ...
        output_2 = await self.default_controller.WriteAttribute(self.dut_node_id, [(endpoint, chosen_writable_attribute(value=123456))])
